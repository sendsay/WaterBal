...
begin
  ...
  begin
    ...
    aEdit.Margins.Right := 10;
    aEdit.Margins.Top := 30;
    aEdit.Margins.Bottom := 20;
  ...
  FHeightSums := 0;
  for i := High(APrompt) downto 0 do
    FHeightSums := 20 + FHeightSums + Labels[i].Height + Edits[i].Height;
...
begin
  ...
  r1.Height := 30 + r1.Padding.Top + Layout1.Height + FHeightSums;
